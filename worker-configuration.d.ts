/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 500e4bf289c4df0ea6ec5ad562b301c5)
// Runtime types generated with workerd@1.20260507.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "CollabRoom";
	}
	interface PreviewEnv {
		AVATARS: R2Bucket;
		DB: D1Database;
		COLLAB_ROOM: DurableObjectNamespace<import("./src/worker").CollabRoom>;
	}
	interface Env {
		AVATARS: R2Bucket;
		DB: D1Database;
